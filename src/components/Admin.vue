          ...
          >
            <v-list-item three-line>
              ...
              <v-list-item-avatar
                ...
                color="grey"
              >
              <img :src="item.cover_image || require('@/assets/tsg.jpg')" alt="cover_image"/>
              </v-list-item-avatar>
            </v-list-item>
      ...
      <v-card>
        ...
        <v-card-text class="mt-3">
          ...
          <v-file-input
            ...
            outlined v-model="form1.cover_image"
...
export default {
  ...
  methods: {
    ...
    async submit(){
      ...
      let uploaded = await this.$helpers.fileUploader(
